...
;  Language: X86-64
;  Purpose: Sorts an array of pointers
;
; ========1=========2=========3=========4=========5=========6=========7=========8=========9=========0=========1=========2=========3**
...
sort_pointers:
    ...
    mov r9, rsi  ; Maximnum Array Size
...
sweep:
    ...
    ; if sorted, jump to end
    cmp r11, r9
    je done

    ; if true, restart sweep
    cmp r10, r9
    jge restart

    ; if swap necessary, start by temp storing
    mov r12, [r8 + r10 * 8 - 8]
    mov r13, [r8 + r10 * 8]
    movsd xmm8, [r12]
    movsd xmm9, [r13]
